...
module.exports = {
     ...
     */
    botname: process.env.BotName || "Queen Avishna",
    footer: process.env.Footer || "© Powered By Queen Avishna Bot",
     ...
     */
    ownername: process.env.Owner_Name || "SMOKY",
    ownernumber: process.env.Owner_Number || "919207278115",
    instagramId: process.env.Insta || "mr.luttapi_kidy",
    ...
    mongoUrl: process.env.MongoDB || "mongodb+srv://<db_junaid>:<db_eLWkJ5sKheboFEgK>@cluster0.ysvhj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0",
    sessionId: process.env.SESSION_ID || "OWc0d_Queen-Anya_nd_Queen-Anya_nMzI=",
